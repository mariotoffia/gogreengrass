...
If you stick with the autogenerated, make sure that your handler is set to: *glue.function_handler*. If you bind the IoT Core -> Lambda on e.g. topic: _invoke/ggtest_, open the test utility to and post to _invoke/ggtest_:
...
```
[2020-11-16T21:55:08.122Z][INFO]-context: &{c760d735-5e69-4ffc-5a76-1460197dcd71 arn:aws:lambda:eu-central-1:033549287452:function:ggtest:11 { } {{   } map[] map[subject:invoke/ggtest]}}, topic: invoke/ggtest, data: '{49 world!}'
```
...
`googreengrass` has the following flags to control the glue generation:
